<tr>
    ...
    <td>
        <a href="{{route("pvp.character", ['slug' => $event->slug, "id" => $item->id])}}" class="{{\App\Http\Controllers\Auth\AuthController::isItMe($item->id) ? "text-danger" : "text-dark"}}" data-toggle="tooltip" title="{{$item->name}}">
