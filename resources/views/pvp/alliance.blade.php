@extends("layout.app")
@section("browser-title",$alliance->name . " - " . $event->name)
@section("content")
    <div class="my-5">
        <div class="col-sm-12 col-md-12">
            <div id="banner" class="shadow-sm">
                <img src="https://images.evetech.net/alliances/{{$alliance->id}}/logo?size=128" class="rounded-circle shadow-sm">
                <h4 class="font-weight-bold ">{{$alliance->name}}<small> in {{$event->name}}</small></h4>
            </div>
        </div>
    </div>
