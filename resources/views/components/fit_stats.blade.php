...
<div class="card card-body border-0 shadow-sm mt-3">
    ...
    <table class="table-sm w-100">
        ...
        <tr>
            <td class="w-20p"><img src="/_icons/fit/cpu.png" alt="CPU icon" class="tinyicon"></td>
            <td>CPU</td>
            <td>
        ...
        <tr>
            <td class="w-20p"><img src="/_icons/fit/powergrid.png" alt="Powergrid icon" class="tinyicon"></td>
            <td>Powergrid</td>
            <td>
    ...
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div>
            <table class="table-sm">
                <tr>
                    <td><img src="/_icons/fit/turret_missile.png" class="tinyicon" alt=""></td>
                    <td>Weapons</td>
                    <td class="text-right">{{round($stats->offense->weaponDps)}}</td>
                    <td><span class="text-small bringupper">dps</span></td>
                </tr>
                <tr>
                    <td><img src="/_icons/fit/drone.png" class="tinyicon" alt=""></td>
                    <td>Drones</td>
                    <td class="text-right">{{round($stats->offense->droneDps)}}</td>
                    <td><span class="text-small bringupper">dps</span></td>
                </tr>
                <tr>
                    <td><img src="/_icons/fit/volley.png" class="tinyicon" alt=""></td>
                    <td>Volley</td>
...
<div class="card card-body border-0 shadow-sm mt-3">
    ...
    <table class="table table-sm w-100">
        <tr>
            <td></td>
            <td class="text-center" data-toggle="tooltip" title="EM resistance"><img class="smallicon" src="/_icons/fit/em.png"></td>
            <td class="text-center" data-toggle="tooltip" title="Thermal resistance"><img class="smallicon" src="/_icons/fit/therm.png"></td>
            <td class="text-center" data-toggle="tooltip" title="Kinetic resistance"><img class="smallicon" src="/_icons/fit/kin.png"></td>
            <td class="text-center" data-toggle="tooltip" title="Explosive resistance"><img class="smallicon" src="/_icons/fit/exp.png"></td>
            <td class="text-right" data-toggle="tooltip" title="Effective Hitpoints (EHP) - with resistance calculated in"><img class="smallicon" src="/_icons/fit/hp.png"></td>
        </tr>
        <tr>
            <td data-toggle="tooltip" title="Shield"><img class="smallicon" src="/_icons/fit/shield.png"></td>
        ...
        <tr>
            <td data-toggle="tooltip" title="Armor"><img class="smallicon" src="/_icons/fit/armor.png"></td>
        ...
        <tr>
            <td data-toggle="tooltip" title="Hull"><img class="smallicon" src="/_icons/fit/hull.png"></td>
...
<div class="card card-body border-0 shadow-sm mt-3">
    ...
    <table class="table table-sm w-100">
        <tr>
            <td>&nbsp;</td>
            <td class="text-right" data-toggle="tooltip" title="Passive shield recharge"><img class="smallicon" src="/_icons/fit/shield_recharge.png"></td>
            <td class="text-right" data-toggle="tooltip" title="Shield boost"><img class="smallicon" src="/_icons/fit/shield_boost.png"></td>
            <td class="text-right" data-toggle="tooltip" title="Armor repair"><img class="smallicon" src="/_icons/fit/armor_repair.png"></td>
            <td class="text-right" data-toggle="tooltip" title="Hull repair"><img class="smallicon" src="/_icons/fit/hull_repair.png"></td>
        </tr>
        <tr>
            <td class="text-center" data-toggle="tooltip" title="Burst repairs"><img class="smallicon" src="/_icons/fit/burst.png"></td>
        ...
        <tr>
            <td class="text-center" data-toggle="tooltip" title="Sustained repairs"><img class="smallicon" src="/_icons/fit/sustained.png"></td>
...
<div class="card card-body border-0 shadow-sm mt-3">
    ...
    <table class="table-sm w-100">
        <tr>
            ...
            @endif
        <tr>
            <td><img src="/_icons/fit/capacitor.png" class="smallicon" alt="Icon">&nbsp;Capacity</td>
...
<div class="card card-body border-0 shadow-sm mt-3">
    ...
    <table class="table-sm w-100">
        <tr>
            <td><img src="/_icons/fit/propulsion.png" alt="Icon" class="smallicon">&nbsp;Speed</td>
            <td class="text-right">{{number_format($stats->misc->maxSpeed, 0, ",", " ")}}</td>
            <td><span class="text-small bringupper">m/s</span></td>
        </tr>
        <tr>
            <td><img src="/_icons/fit/tp.png" alt="Icon" class="smallicon">&nbsp;Signature radius</td>
            <td class="text-right">{{number_format($stats->misc->signature, 1, ",", " ")}}</td>
            <td><span class="text-small bringupper">m</span></td>
        </tr>
        <tr>
            <td><img src="/_icons/fit/targeting_range.png" alt="Icon" class="smallicon">&nbsp;Targeting range</td>
            <td class="text-right">{{number_format($stats->misc->targeting->range, 0, ",", " ")}}</td>
            <td><span class="text-small bringupper">m</span></td>
        </tr>
        <tr>
            <td><img src="/_icons/fit/targeting_resolution.png" alt="Icon" class="smallicon">&nbsp;Scan resolution</td>
            <td class="text-right">{{number_format($stats->misc->targeting->resolution, 0, ",", " ")}}</td>
            <td><span class="text-small bringupper">mm</span></td>
        </tr>
        <tr>
            <td><img src="/_icons/fit/targeting_strength.png" alt="Icon" class="smallicon">&nbsp;Sensor strength</td>
