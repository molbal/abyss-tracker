        ...
        <div class="col-md-12 col-sm-12">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="nav-link active" id="tab-head-distribution" data-toggle="tab" href="#tab-graph-cruiser" role="tab" aria-controls="home" aria-selected="true">Cruiser size</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="tab-head-distribution" data-toggle="tab" href="#tab-graph-destroyer" role="tab" aria-controls="home" aria-selected="true">Destroyer size</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="tab-head-distribution" data-toggle="tab" href="#tab-graph-frigate" role="tab" aria-controls="home" aria-selected="true">Frigate size</a>
                </li>
            </ul>
            <div class="card card-body border-0 shadow-sm top-left-no-round">
                <div class="tab-content" id="tab-graph-cruiser">
                    ...
                    <div class="tab-pane fade" id="tab-graph-destroyer" role="tabpanel" aria-labelledby="tab-head-activity">
                        <div class="graph-container h-300px">
                            {!! $destroyerChart->container(); !!}
                        </div>
                    </div>
                    <div class="tab-pane fade" id="tab-graph-frigate" role="tabpanel" aria-labelledby="tab-head-activity">
                        <div class="graph-container h-300px">
