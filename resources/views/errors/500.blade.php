            ...
            <div class="card mb-5 text-left shadow">
                <div class="card-header">
                    ...
                    <div class="card-body shadow-sm border-0 mb-0">
                        <p class="lead mb-0 pb-0">Error 500</p>
                        <p>This is an 'Internal Server Error' - this is sometimes caused by EVE downtime (<a href="https://eve-offline.net/">check here</a>) or its simply caused by a bug in the Abyss Tracker.</p>
                    </div>
